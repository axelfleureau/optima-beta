...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const { isAuthenticated, isInitialized, loading: authLoading } = useAuthStatus()
  ...
  useEffect(() => {
    if (!authLoading && reduxUser && roleHelpers.isSuspended && window.location.pathname !== "/suspended") {
