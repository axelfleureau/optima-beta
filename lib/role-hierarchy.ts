...
export function getManageableRoles(userRole: UserRole): UserRole[] {
  ...
  if (userRole === "admin") {
    return ["direzione", "capo-reparto", "junior", "freelance", "client"];
  }

  if (userRole === "direzione") {
    return ["capo-reparto", "junior", "freelance", "client"];
  }

  if (userRole === "capo-reparto") {
    return ["junior", "freelance", "client"];
  }
...
export function canViewResource(
  ...
  // Junior, freelance and client can only view their own resources
