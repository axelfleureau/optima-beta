...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        righello:
          "0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06), 0 0 0 1px rgba(148, 163, 184, 0.1)",
        "righello-lg":
          "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04), 0 0 0 1px rgba(148, 163, 184, 0.15)",
        ...
        "corporate-subtle": "0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.1)",
        "corporate-medium": "0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)",
        "corporate-strong": "0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.1)",
      },
      backgroundImage: {
      ...
      transitionDuration: {
        "corporate-instant": "100ms",
        "corporate-fast": "150ms",
        "corporate-normal": "200ms",
      },
      transitionTimingFunction: {
        "corporate": "cubic-bezier(0.4, 0, 0.2, 1)",
        "corporate-smooth": "cubic-bezier(0.33, 1, 0.68, 1)",
      },
    },
  },
