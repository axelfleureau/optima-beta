...
export function KanbanColumn({
  ...
  return (
    <div key={column.id} className="flex min-h-[70dvh] min-w-[88vw] max-w-[88vw] snap-start flex-col [touch-action:pan-x_pan-y] sm:min-w-[420px] sm:max-w-[420px] lg:h-full lg:min-h-0 lg:min-w-[312px] lg:max-w-none xl:w-88">
