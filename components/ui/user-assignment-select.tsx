...
export function UserAssignmentSelect({
  ...
  const getFullName = (user: UserType) => {
    return (
      [user.firstName, user.lastName].filter(Boolean).join(" ") || "Utente"
    );
  };
        ...
        <SelectValue placeholder={placeholder}>
          {selectedUser && (
            <div className="flex items-center gap-2">
              ...
              <Badge
                className={`text-xs ${roleColors[selectedUser.role as keyof typeof roleColors]} border-0`}
              >
                {selectedUser.role}
              </Badge>
            </div>
                ...
                <div className="flex items-center gap-3 w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge
                        className={`text-xs ${roleColors[user.role as keyof typeof roleColors]} border-0 flex items-center gap-1`}
                      >
