...
import { AGENT_ADMIN_ROLES, appendAgentJobEvent, getAgentJob, listAgentJobArtifacts } from "@/lib/agent-jobs"
...
export async function GET(_request: NextRequest, context: RouteContext) {
  try {
    ...
    const artifacts = await listAgentJobArtifacts(auth.db, auth.principal.organizationId, id)
