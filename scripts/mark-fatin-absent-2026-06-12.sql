-- Mark Fatin Lachhab absent on 2026-06-12.
...
SELECT
  'day_fatin_lachhab_20260612_absent',
  organization_id,
  id,
  '2026-06-12',
  NULL,
  ...
  'absent',
  'Assenza',
  'Correzione direzione: assenza Fatin Lachhab per venerdi 12 giugno 2026.',
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
FROM members
...
ON CONFLICT(organization_id, member_id, entry_date) DO UPDATE SET
  ...
  notes = 'Correzione direzione: assenza Fatin Lachhab per venerdi 12 giugno 2026.',
