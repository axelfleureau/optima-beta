...
-- Righello Live Studio e un prodotto Righello, non un cliente separato.
UPDATE projects
SET client_id = 'client_internal_righello_ops',
    name = 'Righello Live Studio',
    updated_at = CURRENT_TIMESTAMP
WHERE organization_id = 'org_demo_righello'
  AND id = 'project_internal_obs_padel_stream_overlay';
...
DELETE FROM clients
WHERE id IN ('client_internal_reguta_gest', 'client_rig_reguta_anselmi', 'client_internal_obs_padel')
...
('project_internal_obs_padel_stream_overlay', 'org_demo_righello', 'client_internal_righello_ops', 'Righello Live Studio', 'active', 0, '2026-05-28T13:00:00.000Z', '2026-06-30T18:00:00.000Z', '2026-05-28T13:00:00.000Z', CURRENT_TIMESTAMP),
...
WITH new_tasks (
  ...
  ('task_axel_ext3_20260602_obs', 'org_demo_righello', 'project_internal_obs_padel_stream_overlay', 'mem_axel_wearerighello', '2026-06-02 - Righello Live Studio know-how repository cleanup', 'Playbook sviluppo spostato fuori dal repository progetto.', 'done', 'low', 30, 30, '2026-06-02T18:00:00.000Z', '2026-06-02T12:30:00.000Z', '2026-06-02T18:00:00.000Z', 'done', 'client_internal_righello_ops', 'Righello', 'Workflow Know-how', 5, 'Aggiunto playbook know-how sviluppo. Spostato playbook know-how fuori dal repository progetto.', 'Axel Fleureau', '["github-real","2026-06-02","righello-live-studio","righello-product","knowhow","cleanup"]', '[]', '[]', '[]', 'mem_axel_wearerighello', 'accepted', 'mem_axel_wearerighello', '2026-06-02T12:30:00.000Z', '2026-06-02T18:00:00.000Z', NULL),
